# insert_test_ressources.py
import sqlite3

conn = sqlite3.connect("database.db")
cursor = conn.cursor()

# 12 valeurs : code_elevage, type_ressource, espece, effectif, production, quantite_annuelle, destination, type_revenu, description, montant_annuel, periodicite, saisonnalite
test_data = [
    # Animaux (colonnes revenu à NULL)
    ...
    # Revenus extérieurs (colonnes animaux à NULL)
